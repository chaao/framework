 ...
 * @date 2017年3月8日
 */
public class ShardedJedisExecutor implements JedisCommands, BinaryJedisCommands {

	private ShardedJedisPool connectionHandler;
	 ...
	 * @param maxAttempts
	 */
	public ShardedJedisExecutor(ShardedJedisPool connectionHandler, int maxAttempts) {
		super();
	...
	public String set(final String key, final String value) {
		return new ShardedJedisCommand<String>(connectionHandler, maxAttempts) {
			@Override
	...
	public Boolean exists(final String key) {
		return new ShardedJedisCommand<Boolean>(connectionHandler, maxAttempts) {
			@Override
	...
	public Long persist(final String key) {
		return new ShardedJedisCommand<Long>(connectionHandler, maxAttempts) {
			@Override
	...
	public Double incrByFloat(final String key, final double value) {
		return new ShardedJedisCommand<Double>(connectionHandler, maxAttempts) {
			@Override
	...
	public List<String> hmget(final String key, final String... fields) {
		return new ShardedJedisCommand<List<String>>(connectionHandler, maxAttempts) {
			@Override
	...
	public Set<String> hkeys(final String key) {
		return new ShardedJedisCommand<Set<String>>(connectionHandler, maxAttempts) {
			@Override
	...
	public Map<String, String> hgetAll(final String key) {
		return new ShardedJedisCommand<Map<String, String>>(connectionHandler, maxAttempts) {
			@Override
	...
	public Set<Tuple> zrangeWithScores(final String key, final long start, final long end) {
		return new ShardedJedisCommand<Set<Tuple>>(connectionHandler, maxAttempts) {
			@Override
	...
	public ScanResult<Entry<String, String>> hscan(final String key, final String cursor) {
		return new ShardedJedisCommand<ScanResult<Entry<String, String>>>(connectionHandler, maxAttempts) {
			@Override
			public ScanResult<Entry<String, String>> execute(ShardedJedis connection) {
	...
	public ScanResult<String> sscan(final String key, final String cursor) {
		return new ShardedJedisCommand<ScanResult<String>>(connectionHandler, maxAttempts) {
			@Override
	...
	public ScanResult<Tuple> zscan(final String key, final String cursor) {
		return new ShardedJedisCommand<ScanResult<Tuple>>(connectionHandler, maxAttempts) {
			@Override
	...
	public List<GeoCoordinate> geopos(final String key, final String... members) {
		return new ShardedJedisCommand<List<GeoCoordinate>>(connectionHandler, maxAttempts) {
			@Override
	...
	public List<GeoRadiusResponse> georadius(final String key, final double longitude, final double latitude,
		...
		return new ShardedJedisCommand<List<GeoRadiusResponse>>(connectionHandler, maxAttempts) {
			@Override
	...
	public List<Long> bitfield(final String key, final String... arguments) {
		return new ShardedJedisCommand<List<Long>>(connectionHandler, maxAttempts) {
			@Override
			public List<Long> execute(ShardedJedis connection) {
